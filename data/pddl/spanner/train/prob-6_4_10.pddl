...
(define (problem prob)
  (:domain spanner)
  (:objects bob spanner1 spanner2 spanner3 spanner4 spanner5 spanner6 nut1 nut2 nut3 nut4 location1 location2 location3 location4 location5 location6 location7 location8 location9 location10 shed gate)
  (:init
    (at bob shed)
