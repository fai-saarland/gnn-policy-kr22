...
def get_init(args):
    ...
    str_init = str_init + "    (link-forward shed location1)\n"
    str_init = str_init + "    (link-backward location1 shed)\n"
    str_init = str_init + "    (link-forward location" + str(args.locations) + " gate)\n"
    str_init = str_init + "    (link-backward gate location" + str(args.locations) + ")\n"

    for i in range(1, args.locations):
        str_init = str_init + "    (link-forward location" + str(i) + " location" + str(i + 1) + ")\n"
        str_init = str_init + "    (link-backward location" + str(i + 1) + " location" + str(i) + ")\n"
