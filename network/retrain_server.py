...
class BugStatesCallback(Callback):
    pass
...
def _main(args):
    ...
    train_loader = DataLoader(train_dataset, shuffle=True, pin_memory=True, **loader_params)
    validation_loader = DataLoader(validation_dataset, shuffle=False, pin_memory=True,  **loader_params)
    print(
